...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-900 shadow-sm dark:bg-gray-900 fixed w-full top-0 left-0 right-0 z-50">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        {/* Brand */}
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src={telephoneIcon} className="h-8 shadow rounded-full" alt="Smart Contact Manager Logo" />
        ...
        <div className="flex gap-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <Link
            to="/login"
            type="button"
            className="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Login
          </Link>
          <Link
